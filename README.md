...
Проект сделан как учебный и практический инструмент
для отработки понимания IPv4, CIDR и логики подсетей.
Использую его для самопроверки и повторения сетевых тем.
